...
const PartnerDashboard = () => {
  ...
  const getTierInfo = (tierId) => {
    const tiers = {
      'tier-1': { name: 'ATS Optimise', color: primaryColor },
      'tier-2': { name: 'Professional Package', color: primaryColor },
      'tier-3': { name: 'Executive Elite', color: primaryColor }
    };
    return tiers[tierId] || { name: 'Free', color: 'gray' };
  };

  const onboardingSteps = [
    { id: 'profile', label: 'Complete your profile', done: !!user?.full_name, link: `${baseUrl}/dashboard/settings` },
    { id: 'ats', label: 'Check your CV with ATS', done: stats?.ats_checks > 0, link: `${baseUrl}/ats-checker` },
    { id: 'cv', label: 'Create your first CV', done: stats?.total_documents > 0, link: `${baseUrl}/builder` },
    { id: 'linkedin', label: 'Try LinkedIn tools', done: stats?.linkedin_used, link: `${baseUrl}/linkedin-tools` },
    { id: 'plan', label: 'Upgrade your plan', done: !!user?.active_tier, link: `${baseUrl}/pricing` }
  ];
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Activated {user.tier_activation_date ? new Date(user.tier_activation_date).toLocaleDateString() : 'Recently'}
                  </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <Link to={`${baseUrl}/ats-checker`} className="block p-3 border rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors">
              <div className="flex items-center justify-between">
            ...
            <Link to={`${baseUrl}/linkedin-tools`} className="block p-3 border rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-blue-100 rounded-lg">
            ...
            <Link to={`${baseUrl}/dashboard/interview-prep`} className="block p-3 border rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-purple-100 rounded-lg">
