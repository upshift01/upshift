...
def get_talent_pool_routes(db, get_current_user):
    ...
    async def get_my_talent_profile(current_user: dict = Depends(get_current_user)):
    ...
    async def get_candidate_profile(profile_id: str, current_user: dict = Depends(get_current_user)):
