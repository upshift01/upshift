                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Input
                      ...
                      min="0"
                      placeholder="e.g. 899"
                      value={formatPrice(tierConfig.tier_2.price)}
                      onChange={(e) => updateTier('tier_2', 'price', parsePrice(e.target.value))}
                      className="pl-8"
                    />
                  </div>
                  <p className="text-xs text-gray-500 mt-1">Enter the price in Rands (e.g., 899 for R899.00)</p>
                </div>
                <div>
                  <Label className="flex items-center justify-between">
                    Features
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Input
                      ...
                      value={formatPrice(tierConfig.tier_3.price)}
                      onChange={(e) => updateTier('tier_3', 'price', parsePrice(e.target.value))}
                      className="pl-8"
                    />
                  </div>
                  <p className="text-xs text-gray-500 mt-1">Enter the price in Rands (e.g., 2999 for R2999.00)</p>
                </div>
                <div>
                  <Label className="flex items-center justify-between">
                    Features
